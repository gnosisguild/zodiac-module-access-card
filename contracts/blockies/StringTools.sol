...
library StringTools {
     ...
     */
    function stringStartsWith(string memory haystack, string memory needle) internal pure returns (bool) {
     ...
     */
    function indexOfStringInString(string memory needle, string memory haystack) internal pure returns (int256) {
    ...
    function hexStringFromBytes(bytes memory chars) public pure returns (string memory) {
    ...
    function asciiCharFromHexByte(bytes1 word) public pure returns (string memory) {
